...
public enum ErrorType {
    ...
    NOT_CORRECT_RUNTIME(400, "희망 산책 시간 설정이 올바르지 않습니다."),
    NOT_FOUND_TRAIL_IMG(401, "산책로 이미지가 존재하지 않습니다."),
    //--------------------------------------------------------------------
    //---------------------------찜하기 관련 부분----------------------------
    ...
    ALREADY_EXIST_USER_NICKNAME(401, "이미 존재하는 닉네임입니다."),
    //--------------------------------------------------------------------
    //---------------------------추천 산책로 관련 부분-------------------------
    NOT_FOUND_RECUSER(401, "사용자의 선호 정보를 찾을 수 없습니다."),
    //--------------------------------------------------------------------
    //---------------------------FASTAPI 관련 부분--------------------------
    FASTAPI_ERROR(500, "FASTAPI와 통신 중 에러가 발생했습니다"),
    JSON_PASSING_ERROR(400, "JSON 파싱에러가 발생했습니다."),
    ;
